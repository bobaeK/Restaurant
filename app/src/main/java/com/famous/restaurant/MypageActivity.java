...
public class MypageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RegisteredReviewAdapter adapter=new RegisteredReviewAdapter();
        ...
        adapter.addItem(new RegisteredReviewItem("마루스시 "+"2017/11/05 "+"사장님도 친절하시고 가게 분위기가 너무 좋았어요!"));
        adapter.addItem(new RegisteredReviewItem("마루스시 "+"2017/11/05 "+"사장님도 친절하시고 가게 분위기가 너무 좋았어요!"));
        adapter.addItem(new RegisteredReviewItem("마루스시 "+"2017/11/05 "+"사장님도 친절하시고 가게 분위기가 너무 좋았어요!"));
        adapter.addItem(new RegisteredReviewItem("마루스시 "+"2017/11/05 "+"사장님도 친절하시고 가게 분위기가 너무 좋았어요!"));
        adapter.addItem(new RegisteredReviewItem("마루스시 "+"2017/11/05 "+"사장님도 친절하시고 가게 분위기가 너무 좋았어요!"));
        ...
        ArrayAdapter<TextView> certifiedAdapter = new ArrayAdapter(this, simple_list_item_1, certifiedStoreList);
